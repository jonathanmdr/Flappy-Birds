...
public class TelaJogo extends TelaBase {
    ...
    /**
     * Recria a tela do jogo com todos os seus componentes, e destrói a anterior.
     */
    ...
    public void render(float delta) {
        ...
        Gdx.gl.glClear(GL20.GL_COLOR_BUFFER_BIT); //mantém o buffer de cores
    ...
    private void atualizarObstaculos() {
        //enquanto a lista tiver menos que 4 obstaculos, crie um novo obstaculo;
        while(obstaculos.size < 4){
            Obstaculo ultimo = null;
            if (obstaculos.size > 0){
                ultimo = obstaculos.peek(); //comando .peek() recupera o ultimo item da lista
            }
            Obstaculo o = new Obstaculo(mundo, camera, ultimo, texturaObstaculoCima, texturaObstaculoBaixo);
            obstaculos.add(o);
        }
        //verifica se os obstaculos sariam da tela para removê-los
