...
/**
 * Created by jonat_000 on 26/10/2015.
 */
public class Obstaculo {
    ...
    private void initPosicao() {
        ...
        // parcela é o tamanho da tela dividido por 6,
        // para encontrar a posição Y dos obstáculos
        float parcela = (altura - Util.ALTURA_CHAO) / 6;

        int multiplicador = MathUtils.random(1, 3); // numero aleatório entre 1 e 3;

        posYBaixo = Util.ALTURA_CHAO + (parcela * multiplicador) - (altura / 2);
        posYCima = posYBaixo + altura + 2f; // 2f espaço entre os canos (Obstaculos);
    }
